...
export const metadata: Metadata = {
  title: 'About',
  description:
    'Learn why KA-26 exists — building digital infrastructure for local communities in North Karnataka. Our story, vision, and the meaning behind the name.',
};
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6 text-gray-500 text-base sm:text-lg leading-relaxed">
              ...
              <p className="text-gray-900 font-medium">
                KA-26 was built to fix that gap.
              </p>
              <p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <div>
                ...
                <div className="space-y-5 text-gray-400 leading-relaxed">
                  ...
                  <p>
                    We are not building KA-26 for North Karnataka because it is an
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-100 text-center">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                KA-26 is the RTO code for Gadag district — where this
