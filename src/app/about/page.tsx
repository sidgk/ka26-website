...
export default function AboutPage() {
  return (
    <>
      ...
      <section className="relative py-20 sm:py-28 bg-[#F3F2EE]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 max-w-5xl mx-auto">
            {/* Vision */}
            <FadeIn>
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#9B1B1B] to-[#7A1515] text-white p-8 sm:p-10 shadow-xl shadow-[#9B1B1B]/10">
            ...
            {/* Mission */}
            <FadeIn delay={0.1}>
              <div className="relative overflow-hidden rounded-3xl p-8 sm:p-10 shadow-sm bg-white border border-[#E5E2DA]">
                <div className="absolute top-0 right-0 w-40 h-40 bg-[#F3F2EE] rounded-full -translate-y-1/2 translate-x-1/2" />
                <div className="relative">
                  <div className="w-12 h-12 rounded-xl bg-[#9B1B1B]/10 text-[#9B1B1B] flex items-center justify-center mb-6">
                    <Target className="w-6 h-6" />
                  </div>
                  <h3 className="text-xl font-bold mb-4 text-[#1A1A18]">Mission</h3>
              ...
              <FadeIn>
                <div>
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-[#1A1A18]">
                      Why North Karnataka
                    </h2>
                  </div>
              ...
              <FadeIn delay={0.15}>
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    <GlassCard key={item.label} variant="light" className="p-5">
                      <h4 className="font-bold text-sm text-[#1A1A18] mb-1">{item.label}</h4>
      ...
      {/* The Identity Section — Brand red */}
      <section className="relative py-20 sm:py-28 bg-[#9B1B1B] grain">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <div className="max-w-4xl mx-auto text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight">
                What{' '}
                <span style={{ color: '#FFD700' }}>&#x0C95;&#x0CC6;</span>A26 means
              </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-5xl mx-auto">
            {/* Ka */}
            <FadeIn>
              <div className="rounded-2xl bg-white/10 backdrop-blur-sm border border-white/15 p-8 text-center h-full">
                <div className="w-16 h-16 rounded-2xl bg-[#FFD700]/20 border border-[#FFD700]/30 flex items-center justify-center mx-auto mb-5">
          ...
          <FadeIn delay={0.2}>
            <p className="mt-12 text-center text-white/60 text-sm max-w-lg mx-auto">
