...
export const metadata: Metadata = {
  ...
  description:
    "Terms and Conditions for using the KA-26 platform, marketplace, and related services.",
};
      ...
      <div className="mx-auto max-w-4xl px-6 py-12">
        <div className="space-y-10 text-base leading-7 text-gray-600">
          ...
          <section>
            ...
            <p className="mt-3">
              Welcome to KA-26. These Terms and Conditions (&quot;Terms&quot;)
              govern your access to and use of the KA-26 platform, including the
            ...
            <p className="mt-3">
              ...
              Terms. If you do not agree, you must not use the Platform. KA-26
          ...
          <section>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6">
              <li>
                ...
                <strong>&quot;we&quot;</strong>,{" "}
                <strong>&quot;us&quot;</strong>, or{" "}
                <strong>&quot;our&quot;</strong> refers to KA-26, a company based
          ...
          <section>
            ...
            <p className="mt-3">
              KA-26 operates as a technology-driven marketplace that connects
              consumers with local sellers, restaurants, pharmacies, and delivery
              partners. KA-26 is an intermediary platform and is not itself the
            ...
            <p className="mt-3">
              ...
              seller. KA-26 facilitates the discovery, ordering, payment, and
          ...
          <section>
            ...
            <div className="mt-3 space-y-3">
              ...
              <p>
                <strong>4.4.</strong> KA-26 reserves the right to suspend or
          ...
          <section>
            ...
            <div className="mt-3 space-y-3">
              ...
              <p>
                ...
                individual sellers and may vary. KA-26 does not control product
              ...
              <p>
                ...
                third-party payment processors. KA-26 does not store your
                payment credentials.
              </p>
              <p>
          ...
          <section>
            ...
            <div className="mt-3 space-y-3">
              ...
              <p>
                <strong>7.5.</strong> KA-26 reserves the right to delist any
          ...
          <section>
            ...
            <div className="mt-3 space-y-3">
              <p>
                ...
                contractors, not employees of KA-26. Nothing in these Terms
              ...
              <p>
                <strong>8.5.</strong> KA-26 reserves the right to deactivate any
          ...
          <section>
            ...
            <div className="mt-3 space-y-3">
              <p>
                ...
                pharmacists and pharmacies. KA-26 does not sell, dispense, or
              ...
              <p>
                <strong>9.3.</strong> KA-26 does not guarantee the suitability of
          ...
          <section>
            ...
            <div className="mt-3 space-y-3">
              <p>
                ...
                and the compilation thereof, is the property of KA-26 or its
                content suppliers and is protected by Indian and international
                copyright laws.
              </p>
              <p>
                <strong>10.2.</strong> The KA-26 name, logo, and all related
                names, logos, product and service names, designs, and slogans are
                trademarks of KA-26. You may not use such marks without prior
                written permission.
              </p>
              <p>
          ...
          <section>
            ...
            <div className="mt-3 space-y-3">
              ...
              <p>
                ...
                KA-26 a non-exclusive, royalty-free, worldwide, perpetual licence
              ...
              <p>
                <strong>11.4.</strong> KA-26 reserves the right to remove any
          ...
          <section>
            ...
            <div className="mt-3 space-y-3">
              <p>
                ...
                applicable law, KA-26, its officers, directors, employees, and
                agents shall not be liable for any indirect, incidental,
                special, consequential, or punitive damages arising out of or
                related to your use of the Platform.
              </p>
              <p>
                <strong>14.2.</strong> KA-26 does not guarantee the quality,
                ...
                consumer and the seller, with KA-26 providing reasonable
                assistance as an intermediary.
              </p>
              <p>
                <strong>14.3.</strong> KA-26 shall not be liable for any loss or
                damage arising from service interruptions, technical failures,
                or force majeure events.
              </p>
              <p>
                <strong>14.4.</strong> In no event shall KA-26&apos;s total
                aggregate liability exceed the amount paid by you to KA-26 in
          ...
          <section>
            ...
            <p className="mt-3">
              You agree to indemnify, defend, and hold harmless KA-26, its
          ...
          <section>
            ...
            <p className="mt-3">
              KA-26 reserves the right to modify these Terms at any time. We
