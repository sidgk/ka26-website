...
export const metadata: Metadata = {
  ...
  description:
    "Refund and Cancellation Policy for orders placed through the KA-26 platform.",
};
        ...
        <div className="space-y-10 text-base leading-7 text-gray-600">
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              through the KA-26 platform (ka26.shop). KA-26 acts as an
          ...
          <section>
            ...
            <div className="mt-3 space-y-3">
              ...
              <p>
                <strong>3.4.</strong> KA-26 will review the complaint in
          ...
          <section>
            ...
            <div className="mt-3 space-y-3">
              ...
              <p>
                <strong>4.3.</strong> KA-26 will coordinate with the seller to
          ...
          <section>
            ...
            <div className="mt-3 space-y-3">
              ...
              <p>
                <strong>6.3.</strong> KA-26 will notify you via the app and/or
          ...
          <section>
            ...
            <div className="mt-3 space-y-3">
              ...
              <p>
                ...
                address due to a Platform or delivery partner error, KA-26 will
          ...
          <section>
            ...
            <ul className="mt-2 list-disc space-y-2 pl-6">
              <li>
                <strong>The KA-26 app:</strong> Navigate to your order history,
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              you may escalate the issue by contacting our support team. KA-26
